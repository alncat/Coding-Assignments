 ...
 */
public abstract class ABall implements Observer {/*Abstract needs to be remove and Aball must be a concrete class (CHANGE ITS NAME) that takes in an IUpdateStrategy in the constructor*/
