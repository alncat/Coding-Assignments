...
/**
 * Utility class that supplies class routines for generating various random
 * values
 */
public class Randomizer implements IRandomizer {
	 ...
	 * 0<=X<=rect.width and 0<=Y<=rect.height.
	 * 
	 * @param rect
	 *            The bounds for the x and y values of the created Point
	...
	/**
	 * Generates a random location point subject to the constraint that
	 * 0<=X<=dim.width and 0<=Y<=dim.height.
	 * 
	 * @param dim
	 *            The bounds for the x and y values of the created Point
	 * @return A Point object whose x and y are subject to the given bounds
	 ...
	 * absolute value of the velocity (speed) within the bound (inclusive)
	 * defined by rect. Thus the resultant velocity may be negative. The given
	 * Rectangle should use all positive values.
	 * 
	 * @param rect
	 *            The bounds for the absolute value of the velocity in the x and
	 *            y directions.
	...
	/**
	 * Returns a random square Dimension, whose width is
	 * maxDim.width/2<=width<=maxDim.width
	 * 
	 * @param maxDim
	 *            The bounds on the side of the created Dimension.
	 ...
	 * 
	 * @param rect
	 *            The bounds for the location of the created rectangle
	 * @param maxDim
	 *            The bounds for the dimensions of the create rectangle
	 * @return A Rectangle with location and dimensions subject to the given
	 *         bounds.
	 */
	...
	/**
	 * Returns a random choice of one of two objects, x and y, where probX is
	 * the probability that x will be picked (0<=x<=1).
	 * 
	 * @param x
