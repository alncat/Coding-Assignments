...
public class Ball implements Observer {
	...
	/**
	 * The interact strategy of the ball. Initially does nothing.
	 */
	private IInteractStrategy _interactStrategy = new IInteractStrategy(){
	...
	/**
	 * Calls the ball's interact strategy on the context, target, and dispatcher
	 * @param target
	 * 		The target ball to interact with
	 * @param disp
	 * 		The dispatcher
	 */
