...
interface IDoubleVector {
	...
	/**
	 * Adds another double vector to the contents of this one. Will throw OutOfBoundsException if
	 * the two vectors don't have exactly the same sizes.
	 * 
	...
	/**
	 * Returns a particular item in the double vector. Will throw OutOfBoundsException if the index
	 * passed in is beyond the end of the vector.
	 * 
	...
	/**
	 * Sets a particular item in the vector. Will throw OutOfBoundsException if we are trying to set
	 * an item that is past the end of the vector.
	 * 
	...
	/**
	 * Returns the L1 norm of the vector (this is just the sum of the absolute value of all of the
	 * entries)
	 * 
	 * @return the L1 norm
	 */
