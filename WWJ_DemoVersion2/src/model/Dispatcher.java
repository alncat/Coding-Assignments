...
/**
 * A simplified Observable class that immediately notifies its Observers when 
 * its notifyAll() method is called.   The changed state of the Dispatcher does 
 * not need to be separately set.
 */
