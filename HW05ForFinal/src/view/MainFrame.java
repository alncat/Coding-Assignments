...
public class MainFrame<TStrategyDropListItem, TPaintDropListItem> extends
	...
	private final JProgressBar progressBar = new JProgressBar(0,3500); /*Max of 3000 with increment of 1 runs for 2 minutes 34 seconds.*/
	...
	private void initGUI() {
		...
		setBounds(100, 100, 900, 1000);//780, 400
		setResizable(false); /*Keeps the window at a fixed size.*/
