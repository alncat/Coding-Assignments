...
public class EllipsePaintStrategy extends ShapePaintStrategy {
	...
	/**
	 * No parameter constructor that creates a prototype ellipse that has twice
	 * the width as height but an average radius of 1. An AffineTranform for
	 * internal use is instantiated.
	 */
	public EllipsePaintStrategy() {
		this(new AffineTransform(), -4.0 / 3.0, -2.0 / 3.0, 4.0 / 3.0 * 2,
				2.0 / 3.0 * 2);
	}
	 ...
	 */
	public EllipsePaintStrategy(AffineTransform at, double x, double y,
