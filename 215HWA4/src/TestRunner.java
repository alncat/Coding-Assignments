...
public class TestRunner {
   ...
   private static String specificTestCaseToRun = "testFoo";
   ...
   public static void main (String[] args) {
      ...
      if (runAllTestCases)
         ...
         whatToRun = Request.aClass (DoubleMatrixTester.class);
      else
         // or a specific one
         whatToRun = Request.method (DoubleMatrixTester.class, specificTestCaseToRun);
      ...
      for (Failure failure : result.getFailures()) {
         ...
         if (failure.getTrace () != null && failure.getException ().getClass () != junit.framework.AssertionFailedError.class)
...
// this listens to the test cases, and prints the progress
