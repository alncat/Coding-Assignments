  ...
  public static void main(String[] args) {
    ...
    while ( counter >= -1) {
      ...
      if (FunUnit1[0] == 0 && counter >= -1) {
        FunUnit1[0] = opcodeLatency(allocation.get(scheduledInstructions.get(counter)[0]+1).getTheOpcode());
        strFun1 = formatPrint(allocation.get(scheduledInstructions.get(counter)[0]+1));
            
        counter--;
        
      }
      if (FunUnit2[0] == 0  && counter >= -1) {
        FunUnit2[0] = opcodeLatency(allocation.get(scheduledInstructions.get(counter)[0]+1).getTheOpcode());
        strFun2 = formatPrint(allocation.get(scheduledInstructions.get(counter)[0]+1));
