...
public interface IModelControlAdapter<TDropListItem> {
	 ...
	 */
	public TDropListItem addStrategy(String packagename, String classname);
	 ...
	 */
	public void makeBall(TDropListItem selectedItem, TDropListItem selectedPaint);
	 ...
	 */
	public void makeSwitcherBall(TDropListItem iPaint);
	...
	public static final IModelControlAdapter NULL_OBJECT = new IModelControlAdapter() {
		public Object addStrategy(String packagename, String classname) {
			return null;
		}
		...
		public void makeSwitcherBall(Object o) {}
