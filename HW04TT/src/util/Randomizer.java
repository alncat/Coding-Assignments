...
public class Randomizer implements IRandomizer {
	...
	/**
	 * Generates a random location point subject to the constraint that 0&lt;=X&lt;=rect.width and
	 * 0&lt;=Y&lt;=rect.height.
	 * 
	...
	/**
	 * Generates a random location point subject to the constraint that 0&lt;=X&lt;=dim.width and
	 * 0&lt;=Y&lt;=dim.height.
	 * 
	...
	/**
	 * Returns a random velocity (as a Point) subject to the constraint that the absolute value of
	 * the velocity (speed) within the bound (inclusive) defined by rect. Thus the resultant
	...
	/**
	 * Returns a random choice of one of two objects, x and y, where probX is the probability that x
	 * will be picked (0&lt;=x&lt;=1).
	 * 
