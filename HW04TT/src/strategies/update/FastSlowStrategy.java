...
public class FastSlowStrategy implements IUpdateStrategy {
	...
	/**
	 * Counts the number of frames that have occurred - used as a timer for the changing speed.
	 */
	private int frameCounter = 0;
	/**
	 * True while the speed is decreasing, false when it is increasing instead.
	 */
	private boolean decrease = false;

	/**
	 * Updates the ball's state by changing its speed over a fixed interval.
	 * 
