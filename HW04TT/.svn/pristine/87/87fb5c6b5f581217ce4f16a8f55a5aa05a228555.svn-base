...
public class BallView<TDropListItem> extends JFrame {
	...
	private final JSpinner spinPaintStrategies = new JSpinner();
	private final JButton btnPaintStrategies = new JButton("Add");
	private final JTextField textFieldPaintStrategies = new JTextField();
	...
	public BallView(@SuppressWarnings("rawtypes") IModelControlAdapter _inModelControlAdapter, @SuppressWarnings("rawtypes") IModelUpdateAdapter _inModelUpdateAdapter) {
	  textFieldPaintStrategies.setColumns(10);
	...
	private void initGUI() {
		...
		hdrPanel.add(textFieldPaintStrategies, "cell 4 0,growx");
		txtStrategyToAdd
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				_modelControlAdapter.makeSwitcherBall();
			}
		});
		...
		hdrPanel.add(spinPaintStrategies, "cell 4 2,growx");
