...
public class DataPacketTest extends TestCase {
	...
	public void testDataPacket() {
		ADataPacket ds = new DataPacket<String>(String.class, "Stuff");
		ADataPacket di = new DataPacket<Integer>(Integer.class, 42);
		ADataPacket dd = new DataPacket<Double>(Double.class, 3.1415926);
