...
public class ChatAppModel {
        ...
        /* Anonymous constructor for the DataPacketAlgo */
        {
                  ...
                  if (roomToJoin != null) {
                    new Thread(() -> {
                      try {
                        ...
                        view.showErrorDialog("Room to Join Error","Encountered a RemoteException error sending a IConnectMessage DataPacket.");
                        e.printStackTrace();
                      }
                    }).start();
                  }
          ...
          setCmd(IConnectBack.class,
              new ADataPacketAlgoCmd<DataPacket<? extends IConnectMessage>, Object, IUser>() {
                ...
                private static final long serialVersionUID = 8298525616007550165L;
  ...
  public void start() {
    ...
    try {
      ...
      view.showErrorDialog("User Stub Error", "Encountered an error with User Stub.");
      e.printStackTrace();
      System.exit(-1);
    }
  ...
  public void stop() {
    try {
      ...
      view.showErrorDialog("Stop Server Error", "Encountered an error with stopping RMI Server");
  ...
  public void inviteToChatroom(String ipAddress) {
    try {
      ...
      if (inviteTo != null) {
        new Thread(() -> {
          ...
          try {
            ...
            view.showErrorDialog("Invite to Chatroom Error", "Encountered an error sending an invite.");
            e.printStackTrace();
          }
        }).start();
      ...
      view.showErrorDialog("Invite to Chatroom Error", "Encountered a NotBoundExceptoin Error for RMI.");
      e.printStackTrace();
    } catch (AccessException e) {
      view.showErrorDialog("Invite to Chatroom Error", "Encountered a AccessException Error for RMI.");
      e.printStackTrace();
    } catch (RemoteException e) {
      view.showErrorDialog("Invite to Chatroom Error", "Encountered a RemoteException Error for RMI.");
      e.printStackTrace();
    }
  }
    ...
    try {
      ...
      new Thread(() -> {
        ...
        try {
          ...
          view.showErrorDialog("Request to Join Chatroom Error", "Problem occurred in requesting to join chatroom.");
          e.printStackTrace();
        }
      }).start();
      ...
      view.showErrorDialog("Request to Join Chatroom Error", "Encountered a RemoteException Error for RMI.");
      e.printStackTrace();
    } catch (NotBoundException e) {
      view.showErrorDialog("Request to Join Chatroom Error", "Encountered a NotBoundException Error for RMI.");
      e.printStackTrace();
    }
  }
