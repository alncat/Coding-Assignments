...
public class TestRunner {
   ...
   private static String specificTestCaseToRun = "testEmptyIterator";
   ...
   public static void main (String[] args) {
      ...
      if (runAllTestCases)
         ...
         whatToRun = Request.aClass (SparseArrayTester.class);
      else
         // or a specific one
         whatToRun = Request.method (SparseArrayTester.class, specificTestCaseToRun);
